...
import { holdEndNoteFall } from './segments/holdEndNote/fall.mjs'
import { holdEndNoteFrozen } from './segments/holdEndNote/frozen.mjs'
import { holdEndNoteHit } from './segments/holdEndNote/hit.mjs'
import { holdEndNoteIntro } from './segments/holdEndNote/intro.mjs'
...
import { swingNoteFall } from './segments/swingNote/fall.mjs'
import { swingNoteFrozen } from './segments/swingNote/frozen.mjs'
import { swingNoteHit } from './segments/swingNote/hit.mjs'
import { swingNoteIntro } from './segments/swingNote/intro.mjs'
...
const components = [initialization, stage, arrow, noteDisplay, slide, connector] as const
